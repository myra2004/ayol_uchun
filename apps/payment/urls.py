...
urlpatterns = [
    ...
    path("usercard/<int:user_id>/list/", ListUserCardsAPIView.as_view(), name="list-usercards"),
    path("usercard/delete/", DeleteUserCardAPIView.as_view(), name="delete-usercard"),
    path("usercard/<str:card_id>/single/", GetSingleUserCardAPIView.as_view(), name="single-usercard"),

    path("usercard/receipt/create/", UserCardReceiptCreateAPIView.as_view(), name="create-receipt"),
    path("usercard/receipt/pay/", UserCardReceiptConfirmAPIView.as_view(), name="pay-receipt"),
